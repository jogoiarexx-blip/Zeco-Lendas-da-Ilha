...
const LEVELS = [
  ...
  { // ---------- Fase 9: Ruínas Submersas ----------
    ...
    platforms: [
      {x:180,y:310,w:100,h:20},{x:340,y:250,w:90,h:20},
      {x:500,y:190,w:100,h:20, move:{axis:'y', range:50, speed:0.9}},
      {x:700,y:270,w:110,h:20},{x:900,y:210,w:90,h:20},
      {x:1100,y:290,w:120,h:20, move:{axis:'x', range:85, speed:0.8}},
      {x:1380,y:230,w:100,h:20},{x:1580,y:170,w:90,h:20},
      {x:1780,y:250,w:110,h:20, move:{axis:'y', range:55, speed:1.0}},
      {x:2050,y:310,w:100,h:20},{x:2250,y:240,w:120,h:20},
      {x:2500,y:180,w:100,h:20, move:{axis:'x', range:70, speed:0.95}},
      {x:2750,y:260,w:110,h:20},{x:2950,y:200,w:100,h:20},
      {x:3120,y:280,w:90,h:20},
    ],
    gems: [
      {x:210,y:270},{x:370,y:210},{x:540,y:150},{x:740,y:230},
      {x:940,y:170},{x:1140,y:250},{x:1420,y:190},{x:1620,y:130},
      {x:1820,y:210},{x:2090,y:270},{x:2290,y:200},{x:2540,y:140},
      {x:2790,y:220},{x:2990,y:160},{x:3160,y:240},{x:120,y:340},{x:3250,y:340},
    ],
    enemies: [
      {x:300,y:355,range:90,dir:1,baseX:300,type:'walker'},
      {x:650,y:355,range:100,dir:-1,baseX:650,type:'jumper'},
      {x:1000,y:355,range:110,dir:1,baseX:1000,type:'charger'},
      {x:1500,y:355,range:100,dir:-1,baseX:1500,type:'walker'},
      {x:1900,y:355,range:120,dir:1,baseX:1900,type:'jumper'},
      {x:2400,y:355,range:90,dir:-1,baseX:2400,type:'charger'},
      {x:2800,y:355,range:100,dir:1,baseX:2800,type:'walker'},
      {x:550,y:130,range:100,dir:1,baseX:550,type:'flyer'},
      {x:1300,y:120,range:110,dir:-1,baseX:1300,type:'flyer'},
      {x:2100,y:130,range:90,dir:1,baseX:2100,type:'flyer'},
      {x:2600,y:120,range:100,dir:-1,baseX:2600,type:'flyer'},
    ],
    spikes: [
      {x:450,y:365,w:70,h:15},{x:850,y:365,w:80,h:15},
      {x:1350,y:365,w:60,h:15},{x:1750,y:365,w:70,h:15},
    ...
    boxes: [
      {x:140,y:346,w:34,h:34,contents:'coin'},
      {x:520,y:156,w:34,h:34,contents:'powerup:wing'},
      {x:920,y:176,w:34,h:34,contents:'coin'},
      {x:1400,y:196,w:34,h:34,contents:'powerup:shield'},
      {x:1800,y:216,w:34,h:34,contents:'coin'},
      {x:2270,y:206,w:34,h:34,contents:'powerup:star'},
      {x:2520,y:146,w:34,h:34,contents:'coin'},
      {x:2970,y:166,w:34,h:34,contents:'powerup:wing'},
      {x:3140,y:246,w:34,h:34,contents:'powerup:shield'},
    ],
    powerups: [
      {x:250,y:280,type:'star'},{x:1200,y:260,type:'wing'},
      {x:2000,y:280,type:'shield'},{x:2700,y:230,type:'star'},
    ],
    silverGem: {x:1600,y:110},
    checkpoints: [{x:1000,y:380},{x:2000,y:380},{x:2800,y:380}],
  },
  { // ---------- Fase 10: Núcleo de Cristal ----------
    ...
    portalX: 3420,
    platforms: [
      {x:170,y:300,w:100,h:20},{x:330,y:240,w:90,h:20},
      {x:490,y:180,w:100,h:20, move:{axis:'y', range:55, speed:1.05}},
      {x:700,y:260,w:110,h:20},{x:900,y:200,w:90,h:20},
      {x:1100,y:280,w:120,h:20, move:{axis:'x', range:90, speed:0.85}},
      {x:1400,y:220,w:100,h:20},{x:1600,y:160,w:90,h:20},
      {x:1800,y:240,w:110,h:20, move:{axis:'y', range:60, speed:0.95}},
      {x:2080,y:300,w:100,h:20},{x:2280,y:230,w:120,h:20},
      {x:2550,y:170,w:100,h:20, move:{axis:'x', range:75, speed:1.0}},
      {x:2800,y:250,w:110,h:20},{x:3000,y:190,w:100,h:20},
      {x:3200,y:270,w:120,h:20, move:{axis:'y', range:50, speed:0.9}},
      {x:3350,y:210,w:90,h:20},
    ],
    gems: [
      {x:200,y:260},{x:360,y:200},{x:530,y:140},{x:740,y:220},
      {x:940,y:160},{x:1140,y:240},{x:1440,y:180},{x:1640,y:120},
      {x:1840,y:200},{x:2120,y:260},{x:2320,y:190},{x:2590,y:130},
      {x:2840,y:210},{x:3040,y:150},{x:3240,y:230},{x:3390,y:170},
      {x:120,y:340},{x:3450,y:340},
    ],
    enemies: [
      {x:280,y:355,range:90,dir:1,baseX:280,type:'walker'},
      {x:600,y:355,range:100,dir:-1,baseX:600,type:'charger'},
      {x:950,y:355,range:110,dir:1,baseX:950,type:'jumper'},
      {x:1400,y:355,range:100,dir:-1,baseX:1400,type:'charger'},
      {x:1850,y:355,range:120,dir:1,baseX:1850,type:'walker'},
      {x:2300,y:355,range:90,dir:-1,baseX:2300,type:'jumper'},
      {x:2700,y:355,range:110,dir:1,baseX:2700,type:'charger'},
      {x:3100,y:355,range:90,dir:-1,baseX:3100,type:'walker'},
      {x:500,y:120,range:100,dir:1,baseX:500,type:'flyer'},
      {x:1200,y:110,range:110,dir:-1,baseX:1200,type:'flyer'},
      {x:2000,y:120,range:90,dir:1,baseX:2000,type:'flyer'},
      {x:2600,y:110,range:100,dir:-1,baseX:2600,type:'flyer'},
      {x:3200,y:120,range:80,dir:1,baseX:3200,type:'flyer'},
    ],
    spikes: [
      {x:420,y:365,w:70,h:15},{x:800,y:365,w:80,h:15},
      {x:1300,y:365,w:60,h:15},{x:1700,y:365,w:70,h:15},
      {x:2200,y:365,w:80,h:15},{x:2650,y:365,w:60,h:15},{x:3050,y:365,w:70,h:15},
    ],
    boxes: [
      {x:140,y:346,w:34,h:34,contents:'coin'},
      {x:510,y:146,w:34,h:34,contents:'powerup:star'},
      {x:920,y:166,w:34,h:34,contents:'coin'},
      {x:1420,y:186,w:34,h:34,contents:'powerup:shield'},
      {x:1820,y:206,w:34,h:34,contents:'coin'},
      {x:2300,y:196,w:34,h:34,contents:'powerup:wing'},
      {x:2570,y:136,w:34,h:34,contents:'powerup:star'},
      {x:3020,y:156,w:34,h:34,contents:'coin'},
      {x:3220,y:236,w:34,h:34,contents:'powerup:shield'},
      {x:3370,y:176,w:34,h:34,contents:'powerup:wing'},
    ],
    powerups: [
      {x:240,y:270,type:'wing'},{x:1150,y:250,type:'star'},
      {x:2100,y:270,type:'shield'},{x:2850,y:220,type:'star'},
    ],
    silverGem: {x:1620,y:100},
    checkpoints: [{x:1000,y:380},{x:2000,y:380},{x:2900,y:380}],
  },
];
...
const THEMES = {
  ...
  agua:    { skyTop: 0x0d3b66, skyBot: 0x1d6a9f, hill: 0x145a7a, ground: 0x2c4a5e, grass: 0x3d8ead, sun: false },
  cristal: { skyTop: 0x2a1450, skyBot: 0x5b2a8a, hill: 0x6b3fa0, ground: 0x4a2870, grass: 0xc77dff, sun: false },
};
